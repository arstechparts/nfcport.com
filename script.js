...
ru:{
  ...
  businessTitle:'NFC для бизнеса',businessAlt:'NFC цифровое меню для бизнеса',businessText:'Перенесите ваш бизнес в цифровую среду и предложите клиентам современный и удобный опыт.',businessDigitalMenu:'<strong>Цифровое меню:</strong> Откройте меню одним касанием NFC — без сканирования QR-кода.',businessGoogle:'Оценки и отзывы Google',businessValet:'Подготовка автомобиля Valet',businessWaiter:'Вызов официанта и запрос счёта',businessWifi:'Быстрый доступ к Wi‑Fi',
